...
Object.defineProperty( oldStandardMaterial.prototype, 'specular_gloss', {
	get: function() { return this._specular_data[1]; },
	set: function(v) { this._specular_data[1] = v; },
	enumerable: true
});

oldStandardMaterial["@blend_mode"] = { type: "enum", values: LS.Blend };

oldStandardMaterial.DETAIL_TEXTURE = "detail";
oldStandardMaterial.NORMAL_TEXTURE = "normal";
oldStandardMaterial.DISPLACEMENT_TEXTURE = "displacement";
oldStandardMaterial.BUMP_TEXTURE = "bump";
oldStandardMaterial.REFLECTIVITY_TEXTURE = "reflectivity";
oldStandardMaterial.IRRADIANCE_TEXTURE = "irradiance";
oldStandardMaterial.EXTRA_TEXTURE = "extra";

oldStandardMaterial.prototype.prepare = function( scene )
{
...
// RENDERING METHODS
oldStandardMaterial.prototype.fillShaderQuery = function( scene )
{
...
oldStandardMaterial.prototype.fillUniforms = function( scene, options )
{
	var uniforms = {};
...
oldStandardMaterial.prototype.getTextureChannels = function()
{
	return [ Material.COLOR_TEXTURE, Material.OPACITY_TEXTURE, Material.AMBIENT_TEXTURE, Material.SPECULAR_TEXTURE, Material.EMISSIVE_TEXTURE, oldStandardMaterial.DETAIL_TEXTURE, oldStandardMaterial.NORMAL_TEXTURE, oldStandardMaterial.DISPLACEMENT_TEXTURE, oldStandardMaterial.BUMP_TEXTURE, oldStandardMaterial.REFLECTIVITY_TEXTURE, Material.ENVIRONMENT_TEXTURE, oldStandardMaterial.IRRADIANCE_TEXTURE, oldStandardMaterial.EXTRA_TEXTURE ];
}
...
*/
oldStandardMaterial.prototype.setProperty = function(name, value)
{
...
*/
oldStandardMaterial.prototype.getPropertiesInfo = function()
{
...
oldStandardMaterial.prototype.getPropertyInfoFromPath = function( path )
{
	if( path.length < 1)
		return;
...
LS.registerMaterialClass( oldStandardMaterial );
LS.oldStandardMaterial = oldStandardMaterial;