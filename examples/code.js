...
var APP = {
	...
	setupScene: function()
	{
		...
		node.material = new LS.Material({ textures: { color: "monitor_textura.png" } });
		...
		node.material = new LS.Material({ emissive:[0.5,0.5,0.5], textures: { color:"button_power.png", emissive: "button_power.png" } });
